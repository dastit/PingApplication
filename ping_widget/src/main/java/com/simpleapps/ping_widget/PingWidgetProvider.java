...
import com.simpleapps.pingme.MainActivity;
import com.simpleapps.pingme.PingAsyncTask;
...
import static com.simpleapps.pingme.PingFragment.EXTRA_HOST_NAME;
import static com.simpleapps.pingme.PingFragment.EXTRA_WIDGET_ID;
...
public class PingWidgetProvider extends AppWidgetProvider {
    ...
    static void updateWidget(Context context, AppWidgetManager appWidgetManager, int
        ...
        RemoteViews views = new RemoteViews(context.getPackageName(),
                                            com.simpleapps.pingme.R.layout.ping_widget);
        if (isConnected(context)) {
            ...
            views.setOnClickPendingIntent(com.simpleapps.pingme.R.id.widget_view,
                                          pendingIntent);

            Calendar calendar = Calendar.getInstance();
            views.setTextViewText(com.simpleapps.pingme.R.id.widget_short_host_name,
                                  shortHostName);
...
//                                  time, date, intervalInMinutes), context);
            ...
            try {
                if (pingTask.get().equals(PingAsyncTask.NO_CONNECTION)) {
                    views.setImageViewResource(com.simpleapps.pingme.R.id.widget_icon,
                                               com.simpleapps.pingme.R.drawable.rect_error);
                } else {
                    views.setImageViewResource(com.simpleapps.pingme.R.id.widget_icon,
                                               com.simpleapps.pingme.R.drawable.rect_ok);
                }
                views.setTextViewText(com.simpleapps.pingme.R.id.widget_responce_time,
